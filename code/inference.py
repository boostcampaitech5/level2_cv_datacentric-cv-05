...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir",
        default=os.environ.get("SM_CHANNEL_EVAL", "/opt/ml/input/data/medical"),
    )
    parser.add_argument(
...
def main(args):
    ...
    ckpt_fpath = osp.join(args.model_dir, "best_val_f1.pth")
    print(ckpt_fpath)
    ...
    split_result = do_inference(
        model, ckpt_fpath, args.data_dir, args.input_size, args.batch_size, split="test"
    )
